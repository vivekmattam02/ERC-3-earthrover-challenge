#!/usr/bin/env python3
"""Legacy MBRA-first indoor runtime snapshot.

Superseded by ``live_indoor_runtime.py --controller mbra``. Retained only for
historical comparison; do not use it for a new rover run.
