#!/usr/bin/env python3
"""Legacy heavy-recovery indoor runtime snapshot.

Superseded by ``live_indoor_runtime.py``. Retained only for historical
comparison; do not use it for a new rover run.
