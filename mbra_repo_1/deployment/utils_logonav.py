...
def load_model(
    ...
    elif model_type_norm == "exaug_dist" or model_type_norm == "exaug_dist_gnm":
        model = ExAug_dist(
            context_size=config["context_size"],
            len_traj_pred=config["len_traj_pred"],
            learn_angle=config["learn_angle"],
    ...
    elif model_type_norm == "exaug_dist_gnm_delay":
    ...
    elif model_type_norm in {"il2_gps", "logonav"}:
        model = IL_gps(
            context_size=config["context_size"],
            len_traj_pred=config["len_traj_pred"],
            learn_angle=config["learn_angle"],
    ...
    elif model_type_norm == "lelan_col" or model_type_norm == "lelan_col2":
        if config["vision_encoder"] == "lelan_clip_film":
    ...
    if model_type_norm in {"nomad", "lelan", "lelan_col", "lelan_col2", "exaug", "exaug_dist_gnm", "exaug_dist", "il_dist", "exaug_dist_gnm_delay", "mbra", "il2_gps", "logonav"}:
