...
This file defines the documentation structure that should be used for the ERC-3 EarthRover Challenge repo.
...
| `CONTEXT.md` | Internal context dump / historical support | Not a canonical user-facing doc |
